...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h2>More than 5 lakh customers across Delhi-NCR are enjoying Otipy's farm fresh produce..And You?</h2>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> Super Fresh-12 hours from farm to fork</li>
              <li><i class="ri-check-double-line"></i> SAFE-Responsibly grown, hygeinically packed</li>
              <li><i class="ri-check-double-line"></i> Atmanirbhar Bharat-Support India's Farmers!</li>
            </ul>
          </div>
        </div>
